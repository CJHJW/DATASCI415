...
new_data$RIAGENDR <- as.factor(new_data$RIAGENDR)
new_data$ALQ151 <- as.factor(new_data$ALQ151)
new_data$DBQ700 <- as.factor(new_data$DBQ700)
new_data$DBQ197 <- as.factor(new_data$DBQ197)
new_data$SMQ020 <- as.factor(new_data$SMQ020)
```
...
new_data$RIAGENDR <- as.factor(new_data$RIAGENDR)
new_data$ALQ121 <- as.factor(new_data$ALQ121)
new_data$ALQ151 <- as.factor(new_data$ALQ151)
new_data$DBQ700 <- as.factor(new_data$DBQ700)
new_data$DBQ197 <- as.factor(new_data$DBQ197)
new_data$SMQ020 <- as.factor(new_data$SMQ020)
